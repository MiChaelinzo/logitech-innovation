...
type ComparisonFeature = {
  ...
  motionflow: string | boolean
  advantage: 'motionflow' | 'neutral' | 'traditional'
}

const workflowComparisons: ComparisonFeature[] = [
  { name: 'AI Asset Generation', traditional: false, motionflow: true, advantage: 'motionflow' },
  { name: 'Physical Dial Control', traditional: false, motionflow: true, advantage: 'motionflow' },
  { name: 'Context-Aware Actions', traditional: false, motionflow: true, advantage: 'motionflow' },
  { name: 'Multi-App Switching', traditional: 'Manual', motionflow: 'Automatic', advantage: 'motionflow' },
  { name: 'Learning Curve', traditional: 'Weeks', motionflow: 'Hours', advantage: 'motionflow' },
  { name: 'Keyboard Shortcuts', traditional: true, motionflow: true, advantage: 'neutral' },
                    ...
                    <tr className="border-b border-border">
                      ...
                      <th className="text-center py-4 px-4 font-semibold">
                        <div className="flex flex-col items-center gap-2">
                          ...
                          <span className="text-primary">MotionFlow AI</span>
                        </div>
                      </th>
                    </tr>
                  </thead>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="pt-4 border-t border-border/30">
                  <div className="flex items-center justify-between text-lg font-semibold">
                    <span>Total Time for All Tasks:</span>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  <div className="flex items-center gap-3 mb-4">
                    <Keyboard size={32} weight="duotone" className="text-muted-foreground" />
