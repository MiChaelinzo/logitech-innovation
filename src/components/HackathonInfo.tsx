...
export function HackathonInfo() {
  ...
  const features = [
    'AI-powered asset generation with physical controls',
    'Multi-application contextual awareness',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            MotionFlow AI represents the future of creative workflows, combining physical precision with artificial intelligence
          </p>
        </motion.div>
              ...
              <CardHeader>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    ...
                    <CardDescription>Key innovations in this submission</CardDescription>
                  </div>
                </div>
              </CardHeader>
